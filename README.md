...
A curated compilation of the best resources for learning music — starting with **guitar**.
...
- [Tab & Song Libraries](#tab--song-libraries)
- [Interactive Fretboard & Theory Sites](#interactive-fretboard--theory-sites)
...
## Websites & Structured Courses

| Resource | Cost | Notes |
|---|---|---|
| [JustinGuitar](https://www.justinguitar.com/) | `FREEMIUM` | The gold standard for free, structured beginner-to-intermediate guitar lessons. Run by Justin Sandercoe. Most content free; optional paid songs/app. |
| [Guitar Tricks](https://www.guitartricks.com/) | `PAID` | 11,000+ lessons, huge song library. $19.99/mo or $179.99/yr. 14-day free trial. |
| [TrueFire](https://truefire.com/) | `PAID` | 40,000+ lessons, 30,000 tabs, 20,000 jam tracks. Great for intermediate/advanced. $29/mo, $249/yr, or $2,499 lifetime. 30-day trial. |
| [JamPlay](https://jamplay.com/) | `PAID` | Genre-based learning paths, jam tracks. Partners with TrueFire for 1,500+ courses. Affordable tiers. |
| [Fender Play](https://www.fender.com/play) | `PAID` | Beginner-friendly guided paths from Fender. $19.99/mo or $149.99/yr. 7-day trial. |
| [JTC Guitar](https://jtcguitar.com/) | `PAID` | Masterclasses, jam tracks, interactive tabs. ~£19.99/mo. 14-day trial. |
| [FaChords](https://www.fachords.com/guitar-lessons/) | `FREEMIUM` | Step-by-step lessons map from beginner to advanced, plus interactive fretboard tools. |
...
| Resource | Cost | Notes |
|---|---|---|
| [GuitarApp](https://guitarapp.com/) | `FREE` | Free app with 200k+ lessons, online tuner, metronome, interactive chord library. Curated YouTube feeds. |
| [Simply Guitar](https://www.simplyguitar.com/) | `FREEMIUM` | Game-style learning with real-time chord recognition. Free core path; paid for full content. |
| [Yousician](https://yousician.com/) | `FREEMIUM` | Gamified audio-recognition learning across guitar, bass, ukulele, piano, vocals. $9.99/mo paid; 7-day trial. |
| [Gibson App](https://www.gibson.app/) | `FREEMIUM` | Guided paths with real-time feedback, from first chords to full songs. |
| [Ultimate Guitar: Chords & Tabs](https://www.ultimate-guitar.com/) | `FREEMIUM` | Companion app for the giant tab/song database (see Tab Libraries). |
| [Songsterr](https://www.songsterr.com/) | `FREEMIUM` | Accurate tabs with playback. Free core; speed/loop/solo features paid. |

---

## YouTube Channels

All channels below are `FREE` unless noted.

| Channel | Focus | Link |
|---|---|---|
| JustinGuitar | Structured beginner-to-advanced lessons | [youtube.com/@JustinGuitar](https://www.youtube.com/@JustinGuitar) |
| Marty Music | Song lessons, blues/rock solos, scales | [youtube.com/@MartyMusic](https://www.youtube.com/@MartyMusic) |
| Paul Davids | Technique, artist habits, gear, fun challenges | [youtube.com/@PaulDavids](https://www.youtube.com/@PaulDavids) |
| Rick Beato | Music theory, ear training, "What Makes This Song Great" | [youtube.com/@RickBeato](https://www.youtube.com/@RickBeato) |
| Andy Guitar | Beginner song lessons and riffs | [youtube.com/@AndyGuitar](https://www.youtube.com/@AndyGuitar) |
| StichMethod Guitar | Fretboard navigation, improvisation, scales made practical | [youtube.com/@StichMethod](https://www.youtube.com/@StichMethod) |
| Fretboard Confidential | Fingerstyle blues, advanced technique (David Hamburger) | [youtube.com/@FretboardConfidential](https://www.youtube.com/@FretboardConfidential) |
| Rick Graham | Advanced technique and lead guitar | [youtube.com/@RickGraham](https://www.youtube.com/@RickGraham) |
| Your Guitar Academy | `FREEMIUM` — free lessons + paid courses | [youtube.com/@YourGuitarAcademy](https://www.youtube.com/@YourGuitarAcademy) |
...
| Resource | Cost | Notes |
|---|---|---|
| [Ultimate Guitar](https://www.ultimate-guitar.com/) | `FREEMIUM` | The biggest tab/chord library — 1M+ songs. Free tabs; Pro subscription for official tabs & tools. |
| [Songsterr](https://www.songsterr.com/) | `FREEMIUM` | Accurate tabs with real-instrument playback. Free core; advanced player features paid. |
| [GuitarApp](https://guitarapp.com/) | `FREE` | Chords and riffs from favorite songs, daily-updated curated feeds. |

---

## Interactive Fretboard & Theory Sites

| Resource | Cost | Notes |
|---|---|---|
| [Fretride](https://fretride.com/) | `FREE` | Adaptive lessons, scale/arpeggio training, CAGED system, fretboard games, built-in tab editor. |
| [Chordly](https://www.chordly.studio/) | `FREE` | Open-source interactive lessons with real-time feedback and a structured learning path. |
| [Guitar Theorist](https://guitartheorist.com/) | `FREEMIUM` | 83 scales/modes, chord voicings, circle of fifths, emotional progression map on an interactive fretboard. |
| [GuitarBear](https://guitarbear.com/) | `FREEMIUM` | Smart tab player, video-synced lessons, tuner, backing tracks. |
| [Guitar Tutor AI](https://guitartutor.ai/) | `FREEMIUM` | Live fretboard visualization, chords/scales with theory explanations. |
| [My Fretboard Trainer](https://myfretboardtrainer.com/) | `FREE` | Game-based fretboard note/chord memorization, CAGED, pentatonics, circle of fifths. |

---

## Free Tools (Tuner / Metronome / Chord Finder)

All `FREE`, browser-based, no install.

| Tool | What it does | Link |
|---|---|---|
| FretLogic | Tuner, metronome, chord charts, scale finder | [fretlogic.studio](https://fretlogic.studio/) |
| Guitar Tool Hub | Interactive fretboard, chord library, scale visualizer, tuner, metronome | [guitartoolhub.com](https://guitartoolhub.com/) |
| GuitarMetrics Tools | 13 tools: tuner, metronome, scale/chord finder, capo/key finder, transposer | [guitarmetrics.com/tools](https://guitarmetrics.com/pages/free-guitar-tools-hub) |
| PluckTune | Tuner, metronome, chord viewer (guitar/bass/ukulele) | [plucktune.app](https://plucktune.app/) |
| BeatTemple | Metronome with ramp mode + chromatic tuner | [beattemple.ca](https://beattemple.ca/) |
| GuitarToneAdapt | Mic tuner, tap-tempo metronome, chord transposer/capo finder | [guitartoneadapt.com/tools](https://guitartoneadapt.com/tools/) |
...
| Resource | Cost | Notes |
|---|---|---|
| [musictheory.net](https://www.musictheory.net/) | `FREE` | Classic lessons, exercises, ear trainers, calculators. Instrument-agnostic. |
| [teoria](https://www.teoria.com/) | `FREE` | Articles, references, and interactive theory exercises. |
| [muted.io](https://muted.io/) | `FREE` | Interactive theory tools for notes, keys, chords, scales — visual and fun. |
| [Music Theory for Guitar (free resources)](https://www.musictheoryforguitar.com/guitar-music-theory-free-resources.html) | `FREE` | Free courses and eBooks focused on guitar-specific theory. |
| [flupe.com guitar lessons](https://www.flupe.com/lessons/guitar-lessons.htm) | `FREE` | Chord/scale relationships, modes, diatonic/modal harmony, improvisation approaches. |
| [TheGuitarLesson — Guitar Theory](https://www.theguitarlesson.com/guitar-theory/) | `FREE` | Beginner-friendly scale and chord-construction tutorials. |

---

## Books

All books below are `PAID` (one-time purchase).

| Book | Author | Topic | Link |
|---|---|---|---|
...
Found a great resource that's missing? Open an issue or PR. Please include:
...
[CC0 1.0 (Public Domain)](https://creativecommons.org/publicdomain/zero/1.0/) — use it freely.